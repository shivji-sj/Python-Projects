...
def main():
	...
	# imput variables
	time_in_minute = st.number_input("Time in Minute"	, min_value=0)*60
...
# ####################################
	time_in_second = st.number_input("Time in second", min_value=0) 
